# Task: Access Log Traffic Summary
An Apache-style access log is available at the absolute path `/app/access.log`. Parse this log file and write your JSON summary report to the exact path `/app/report.json`.
...
## Rules
- Do not modify or delete the input file `/app/access.log`.
